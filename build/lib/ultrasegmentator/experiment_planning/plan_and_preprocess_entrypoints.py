...
from ultrasegmentator.experiment_planning.plan_and_preprocess_api import extract_fingerprints, plan_experiments, preprocess
...
def plan_experiment_entry():
    ...
    parser.add_argument('-preprocessor_name', default='DefaultPreprocessor', type=str, required=False,
                        help='[OPTIONAL] DANGER ZONE! Sets a custom preprocessor class. This class must be located in '
                             'ultrasegmentator.preprocessing. Default: \'DefaultPreprocessor\'. Changing this may affect your '
