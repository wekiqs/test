...
# 显示输出代码的配置
os.environ["TORCHDYNAMO_OUTPUT_CODE"] = "1"

logger.info("Torch Dynamo configuration set successfully")

# Disable automatic dynamic shapes
torch._dynamo.config.automatic_dynamic_shapes = False

# Optionally reset dynamo to ensure the setting takes effect
torch._dynamo.reset()
...
from ultrasegmentator.configuration import ANISO_THRESHOLD, default_num_processes
from ultrasegmentator.evaluation.evaluate_predictions import compute_metrics_on_folder
from ultrasegmentator.inference.export_prediction import export_prediction_from_logits, resample_and_save
from ultrasegmentator.inference.predict_from_raw_data import nnUNetPredictor
from ultrasegmentator.inference.sliding_window_prediction import compute_gaussian
from ultrasegmentator.paths import nnUNet_preprocessed, nnUNet_results
from ultrasegmentator.training.data_augmentation.compute_initial_patch_size import get_patch_size
from ultrasegmentator.training.dataloading.data_loader_2d import nnUNetDataLoader2D
from ultrasegmentator.training.dataloading.data_loader_3d import nnUNetDataLoader3D
from ultrasegmentator.training.dataloading.nnunet_dataset import nnUNetDataset
from ultrasegmentator.training.dataloading.utils import get_case_identifiers, unpack_dataset
from ultrasegmentator.training.logging.nnunet_logger import nnUNetLogger
from ultrasegmentator.training.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss
from ultrasegmentator.training.loss.deep_supervision import DeepSupervisionWrapper
from ultrasegmentator.training.loss.dice import get_tp_fp_fn_tn, MemoryEfficientSoftDiceLoss
from ultrasegmentator.training.lr_scheduler.polylr import PolyLRScheduler
from ultrasegmentator.utilities.collate_outputs import collate_outputs
from ultrasegmentator.utilities.crossval_split import generate_crossval_split
from ultrasegmentator.utilities.default_n_proc_DA import get_allowed_n_proc_DA
from ultrasegmentator.utilities.file_path_utilities import check_workers_alive_and_busy
from ultrasegmentator.utilities.get_network_from_plans import get_network_from_plans
from ultrasegmentator.utilities.helpers import empty_cache, dummy_context
from ultrasegmentator.utilities.label_handling.label_handling import convert_labelmap_to_one_hot, determine_num_input_channels
from ultrasegmentator.utilities.plans_handling.plans_handler import PlansManager
