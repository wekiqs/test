...
from ultrasegmentator.experiment_planning.dataset_fingerprint.fingerprint_extractor import DatasetFingerprintExtractor
from ultrasegmentator.experiment_planning.experiment_planners.default_experiment_planner import ExperimentPlanner
from ultrasegmentator.experiment_planning.verify_dataset_integrity import verify_dataset_integrity
from ultrasegmentator.paths import nnUNet_raw, nnUNet_preprocessed
from ultrasegmentator.utilities.dataset_name_id_conversion import convert_id_to_dataset_name
...
def extract_fingerprints(dataset_ids: List[int], fingerprint_extractor_class_name: str = 'DatasetFingerprintExtractor',
    ...
    """
    fingerprint_extractor_class = recursive_find_python_class(join(ultrasegmentator.__path__[0], "experiment_planning"),
