...
from nnunet.inference.data_iterators import PreprocessAdapterFromNpy, preprocessing_iterator_fromfiles, \
    preprocessing_iterator_fromnpy
from nnunet.inference.export_prediction import export_prediction_from_logits, \
    convert_predicted_logits_to_segmentation_with_correct_shape
from nnunet.inference.sliding_window_prediction import compute_gaussian, \
    compute_steps_for_sliding_window
from nnunet.utilities.file_path_utilities import get_output_folder, check_workers_alive_and_busy
from nnunet.utilities.find_class_by_name import recursive_find_python_class
from nnunet.utilities.helpers import empty_cache, dummy_context
from nnunet.utilities.json_export import recursive_fix_for_json_export
from nnunet.utilities.label_handling.label_handling import determine_num_input_channels
from nnunet.utilities.plans_handling.plans_handler import PlansManager, ConfigurationManager
from nnunet.utilities.utils import create_lists_from_splitted_dataset_folder
...
class nnUNetPredictor(object):
    ...
    def initialize_from_path(self, model_training_output_dir: str,model_path: str):
        """
        ...
        trainer_class = recursive_find_python_class(join(nnunet.__path__[0], "training", "nnUNetTrainer"),
                                                    trainer_name, 'nnunet.training.nnUNetTrainer')
        if trainer_class is None:
            raise RuntimeError(f'Unable to locate trainer class {trainer_name} in nnunet.training.nnUNetTrainer. '
