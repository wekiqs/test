...
from nnunet.inference.export_prediction import convert_predicted_logits_to_segmentation_with_correct_shape
...
from nnunet.utilities.file_path_utilities import check_workers_alive_and_busy
from nnunet.utilities.helpers import empty_cache
from nnunet.utilities.plans_handling.plans_handler import ConfigurationManager, PlansManager
...
if __name__ == '__main__':
    # python nnunet/inference/JHU_inference.py /home/isensee/Downloads/AbdomenAtlasTest /home/isensee/Downloads/AbdomenAtlasTest_pred -model /home/isensee/temp/JHU/trained_model_ep3850
