...
from nnunet.preprocessing.resampling.utils import recursive_find_resampling_fn_by_name
import nnunet
from batchgenerators.utilities.file_and_folder_operations import load_json, join

from nnunet.imageio.reader_writer_registry import recursive_find_reader_writer_by_name
from nnunet.utilities.find_class_by_name import recursive_find_python_class
from nnunet.utilities.label_handling.label_handling import get_labelmanager_class_from_plans
...
if TYPE_CHECKING:
    from nnunet.utilities.label_handling.label_handling import LabelManager
    from nnunet.imageio.base_reader_writer import BaseReaderWriter
    from nnunet.preprocessing.preprocessors.default_preprocessor import DefaultPreprocessor
    from nnunet.experiment_planning.experiment_planners.default_experiment_planner import ExperimentPlanner
...
class PlansManager(object):
    ...
    def experiment_planner_class(self) -> Type[ExperimentPlanner]:
        ...
        experiment_planner = recursive_find_python_class(join(nnunet.__path__[0], "experiment_planning"),
                                                         planner_name,
...
if __name__ == '__main__':
    from nnunet.paths import nnUNet_preprocessed
    from nnunet.utilities.dataset_name_id_conversion import maybe_convert_to_dataset_name
